      ...
      <div className="w-full bg-white rounded-lg shadow-lg md:w-1/3">
        <div className="p-6 text-[#001F3F]">
          ...
          <form onSubmit={handleAddBook}>
            ...
            <div className="mb-4">
              <label className="block font-medium">Book Price (for borrowing)</label>
              <input
                type="number"
                value={price}
                onChange={(e) => setPrice(e.target.value)}
            ...
            <div className="flex justify-end space-x-4">
              <button
                className="px-4 py-2 bg-gray-200 rounded-md hover:bg-gray-300 text-[#001F3F] font-medium"
                type="button"
                onClick={() => {
                  dispatch(toggleAddBookPopup());
                }}
