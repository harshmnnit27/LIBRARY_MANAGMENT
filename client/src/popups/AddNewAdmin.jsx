...
//           <img src={keyIcon} alt="key-icon" className="bg-gray-300 p-5 rounded-1g"/>
...
//           <input type="text" value={name} onChange={(e)=> setName(e.target.value)} placeholder="Admin's Name" className="w-full px-4 py-2 border border-gray-300 rounded-md "></input>
//         </div>

//         <div className="mb-4">
//           <label className="block text-gray-900 font-medium">Email</label>
//           <input type="email" value={email} onChange={(e)=> setEmail(e.target.value)} placeholder="Admin's Email" className="w-full px-4 py-2 border border-gray-300 rounded-md "></input>
//         </div>

//         <div className="mb-4">
//           <label className="block text-gray-900 font-medium">Password</label>
//           <input type="password" value={password} onChange={(e)=> setPassword(e.target.value)} placeholder="Admin's Password" className="w-full px-4 py-2 border border-gray-300 rounded-md "></input>
//         </div>
        ...
        <div className="p-6">
          ...
          <header className="flex justify-between items-center mb-7 pb-5 border-b-[1px] border-[#001F3F]">
            <div className="flex items-center gap-3">
              <img src={keyIcon} alt="key-icon" className="bg-gray-200 p-3 rounded-lg w-12 h-12" />
              <h3 className="text-xl font-bold">Add New Admin</h3>
            </div>
            <img src={closeIcon} alt="close-icon" onClick={() => dispatch(toggleAddNewAdminPopup())} className="cursor-pointer w-6 h-6" />
          </header>
