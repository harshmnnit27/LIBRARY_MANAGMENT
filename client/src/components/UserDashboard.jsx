...
const UserDashboard = () => {
  ...
  const [totalBorrowedBooks, setTotalBorrowedBooks] = useState(e)
  const [totalReturnedBooks, setTotalReturnedBooks] = useState(e)
        ...
        <div className="flex flex-col gap-7 flex-[4]">
          ...
          <div className="flex flex-col lg:flex-row gap-7">
            <div className="flex items-center gap-3 bg-white p-5 max-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300 ">
              <span className="w-[2px] bg-black h-20 lg:h-full"></span>
              <span classname="bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center"><img src={browseIcon} alt="book-icon" className="w-8 h-8" /></span>
