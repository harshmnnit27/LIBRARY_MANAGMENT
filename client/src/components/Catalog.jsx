    ...
    <>
      <main className="relative flex-1 p-6 pt-28 text-[#001F3F]"> {/* ✅ Updated text color */}
        ...
        <header className="flex flex-col gap-3 sm:flex-row md:items-center">
          <button
            className={`relative rounded sm:rounded-tr-none sm:rounded-br-none sm:rounded-tl-lg sm:rounded-bl-lg text-center border-2 font-semibold py-2 w-full sm:w-72 ${filter === "borrowed"
          ...
          <button
            className={`relative rounded sm:rounded-tl-none sm:rounded-bl-none sm:rounded-tr-lg sm:rounded-br-lg text-center border-2 font-semibold py-2 w-full sm:w-72 ${filter === "overdue"
                ? "bg-[#001F3F] text-white border-[#001F3F]" // ✅ Updated color
            ...
            <table className="min-w-full border-collapse text-[#001F3F]"> {/* ✅ Updated text color */}
              ...
              <tbody>
                {booksToDisplay.map((book, index) => (
                  <tr
                    key={index}
                    className={`${(index + 1) % 2 === 0 ? "bg-[#f5faff]" : "bg-white"
