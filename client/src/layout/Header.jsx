...
const Header = () => {
  ...
  return (
    <header className="absolute top-0 bg-white w-full py-4 px-6 left-0 shadow-md flex justify-between items-center z-50">
      ...
      <div className="flex items-center gap-2">
        <img src={userIcon} alt="userIcon" className="w-3 h-8" />
        <div className="flex flex-col text-[#003366]"> {/* [style-modified: text color updated to lighter navy] */}
          <span className="text-sm font-medium sm:text-lg lg:text-xl sm:font-semibold">
            {user?.name || "Guest"}
          </span>
          <span className="text-sm font-medium sm:text-lg sm:font-medium">
      ...
      {/* RIGHT SIDE */}
      <div className="hidden md:flex items-center gap-4">
        <div className="flex flex-col text-sm lg:text-base items-end font-semibold text-[#003366]"> {/* [style-modified: text color updated] */}
          <span>{currentTime}</span>
          <span>{currentDate}</span>
        </div>
        <div className="h-10 w-[2px] bg-[#003366] mx-2" /> {/* [style-modified: divider color updated] */}
        <img
          src={settingIcon}
          alt="settingIcon"
          className="w-8 h-8 cursor-pointer"
